package com.example.nativeloginpage.services;
...
import com.example.nativeloginpage.activities.CallActivity;
...
import com.example.nativeloginpage.util.NetworkConnectionChecker;
import com.example.nativeloginpage.utils.Consts;
import com.example.nativeloginpage.utils.RingtonePlayer;
...
import static com.example.nativeloginpage.utils.Consts.MAX_OPPONENTS_COUNT;
...
public class CallService extends Service {
    ...
    public boolean hangUpCurrentSession(Map<String, String> userInfo) {
        Toast.makeText(this, "HangedUp", Toast.LENGTH_SHORT).show();
        PrivateChat.setIsHangedUp(true);
        stopRingtone();
