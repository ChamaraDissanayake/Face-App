package com.example.nativeloginpage.util;
...
public class ChatPingAlarmManager {
    private static final String TAG = com.example.nativeloginpage.util.ChatPingAlarmManager.class.getSimpleName();
    ...
    private static com.example.nativeloginpage.util.ChatPingAlarmManager instance;
    private static PingFailedListener pingFailedListener;

    public static void setEnabled(boolean enabled) {
        com.example.nativeloginpage.util.ChatPingAlarmManager.enabled = enabled;
    }
    ...
    public static synchronized com.example.nativeloginpage.util.ChatPingAlarmManager getInstanceFor() {
        if (instance == null) {
            instance = new com.example.nativeloginpage.util.ChatPingAlarmManager();
        }
        return instance;
    }
